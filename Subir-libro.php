...
<div class="container-flex">
    ...
    <form action="Guardar-libro.php" method="POST" enctype="multipart/form-data" class="formulario">
        ...
        <div class="form-group">
            ...
            <input type="text" value="<?php echo htmlspecialchars($fetch['Nombre_Estudiante']); ?>" id="subido_por"
                name="subido_por" required readonly>
        </div>

        <div class="form-group">
            <label for="descripcion">Descripción:</label>
            <textarea id="descripcion" name="descripcion" rows="4" placeholder="Escribe una breve descripción del libro"
                required></textarea>
        </div>
